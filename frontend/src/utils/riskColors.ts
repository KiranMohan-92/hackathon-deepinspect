export const RISK_COLORS: Record<string, { hex: string; bg: string; text: string; border: string; glow: string; ring: string; solid: string }> = {
  CRITICAL: {
    hex: "#ff1744",
...
export const RISK_MARKER_SIZE: Record<string, number> = {
  CRITICAL: 14,
  HIGH: 10,
  MEDIUM: 8,
  OK: 6,
...
export const ROAD_COLORS: Record<string, { bg: string; text: string; border: string }> = {
