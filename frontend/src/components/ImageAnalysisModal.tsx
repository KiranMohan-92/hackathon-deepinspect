...
function useDefectCanvas(imgRef: React.RefObject<HTMLImageElement>, canvasRef: React.RefObject<HTMLCanvasElement>, analysis: any, imageLoaded: boolean) {
  useEffect(() => {
...
export default function ImageAnalysisModal() {
  ...
  useDefectCanvas(imgRef as React.RefObject<HTMLImageElement>, canvasRef as React.RefObject<HTMLCanvasElement>, analysis, imageLoaded);
  ...
  const activeDefects = DEFECT_KEYS
    .map((key) => ({ key, ...((analysis as any)[key] || {}) }))
    .filter((d) => d.score >= 2)
    .sort((a, b) => b.score - a.score);

  const overallScore = (analysis as any).overall_visual_score ?? 0;
      ...
      >
        ...
        >
          <div className="flex items-center justify-between px-6 py-4 border-b border-glass-border flex-shrink-0">
            <div>
              <h2 id="modal-title" className="text-sm font-mono font-bold text-white tracking-wider">
                IMAGE ANALYSIS
              </h2>
          ...
          <div className="flex flex-1 overflow-hidden min-h-0">
            <div className="flex-1 bg-void flex items-center justify-center relative overflow-hidden">
              ...
              {(analysis as any).requires_immediate_attention && (
                <div
            ...
            <div className="w-80 flex-shrink-0 flex flex-col border-l border-glass-border overflow-y-auto">
              <div className="px-5 py-4 border-b border-glass-border">
                ...
                <div className="h-1.5 bg-surface-2 rounded-full overflow-hidden" aria-hidden="true">
                  <div
              ...
              {(analysis as any).visible_defects_summary && (
                <div className="px-5 py-4 border-b border-glass-border">
